    ...
    var loadPortfolio = function () {
        ...
        .then(function (data) {
            if (data.data === null) {
                ...
                designer_images.forEach(function (element, idx) {
                ...
                if (receipt_employee.length > 0) {
                    receipt_employee.forEach(function (element, idx) {
                        var date = '';
                ...
                var $beforeType = null;
                if (receipt_resource.length > 0) {
                    receipt_resource.forEach(function (element, idx) {
                        var date = '';
                ...
                var primary_image = images.filter(function (v, i) {
                    return v.pi_is_primary === 'Y';
                });

                if (primary_image.length < 1) {
                    $portfolioPrimaryPicture.remove();
                }
                else {
                    $portfolioPrimaryPicture.css('background-image', "url('" + primary_image[0].pi_after + "')");
                }
