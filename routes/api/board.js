...
router.post('/notice', (req, res) => {
  ...
  knexBuilder.getConnection().then(cur => {
    let query = cur('notice_tbl').select('nt_pk', 'nt_title', 'nt_content', 'nt_reg_dt', 'nt_mod_dt')
      .orderBy('nt_recency')
...
router.post('/faq', (req, res) => {
  ...
  knexBuilder.getConnection().then(cur => {
    let query = cur('faq_tbl').select('faq_pk', 'faq_question', 'faq_answer', 'faq_reg_dt', 'faq_mod_dt')
      .orderBy('faq_recency')
      .limit(pageData.limit)
      .offset(pageData.page);
